...
try:
    model = YOLO(r'C:\Users\vedan\Desktop\license_plate_detection_main\streamlit_deploy_license_plate\best.pt')  # Replace with the path to your trained YOLO model
